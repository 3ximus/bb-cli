	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if useFZF {
			util.ReplaceListWithFzf("--read0 --prompt 'View > '" +
				" --header='\033[1;33mctrl-w\033[m: web view | \033[1;33mctrl-y\033[m: copy issue code | \033[1;33mctrl-t\033[m: transition issue | \033[1;33mctrl-p\033[m: set priority | \033[1;33mctrl-l\033[m: log time'" +
				...
				" --bind 'ctrl-y:execute(echo {2} | xclip -r -in -selection clipboard)'" +
